...
productName = "iClone\\"
version = "7.1\\"
previousVersion = ["7.01\\", "7.02\\"]

localFolder = "D:\\CanPy\\Auto_Installer\\iClone_Program\\7.1\\Installer\\"

# mainFolderPath = "N:\\Master_Source_Neutral\\iClone 7\\"
# mainPatchFolderPath = "N:\\Master_Source_Neutral\\iClone 7\\Patchs\\"
#
# langFolderPath = "N:\\Master_Source_Languages\\iClone 7\\Enu\\"
# langPatchFolderPath = "N:\\Master_Source_Languages\\iClone 7\\Patchs\\Enu\\"

mainFolderPath = "D:\\CanPy\\Auto_Installer\\Master_Source_Neutral\\iClone 7\\"
mainPatchFolderPath = "D:\\CanPy\\Auto_Installer\\Master_Source_Neutral\\iClone 7\\Patchs\\"

langFolderPath = "D:\\CanPy\\Auto_Installer\\Master_Source_Languages\\iClone 7\\Enu\\"
langPatchFolderPath = "D:\\CanPy\\Auto_Installer\\Master_Source_Languages\\iClone 7\\Patchs\\Enu\\"


localSourceFullPath = localFolder + "Pro\\"
localSourceTrialPath = localFolder + "trial\\"

localMainPath = localFolder + "Temp\\Master_Source_Neutral\\iClone\\"
localMainPatchPath = localFolder + "Temp\\Master_Source_Neutral\\iClone\\Patchs\\"

localLangPath = localFolder + "Temp\\Master_Source_Languages\\iClone\\Enu\\"
localLangPatchPath = localFolder + "Temp\\Master_Source_Languages\\iClone\\Patchs\\Enu\\"
...
templateFullData = "Data\\Template Pro\\"
templateTrialData = "Data\\Template trial\\"
...
def copyEmptyFolder():
    try:
        myshutil.copytree ( localFolder+templateCommonData+"Character Creator 2 for iClone Template\\Motion",
                            localLangPatchPath+version+"Data\\Template Common\\Character Creator 2 for iClone Template\\Motion" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+templateCommonData+"Character Creator 2 for iClone Template\\Texture",
                            localLangPatchPath+version+"Data\\Template Common\\Character Creator 2 for iClone Template\\Texture" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+customData+"Character Creator 2 for iClone Custom\\Motion",
                            localLangPatchPath+version+"Data\\Custom Common\\Character Creator 2 for iClone Custom\\Motion" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+customData+"Character Creator 2 for iClone Custom\\Texture",
                            localLangPatchPath+version+"Data\\Custom Common\\Character Creator 2 for iClone Custom\\Texture" )
    except:
        print "already exist."
...
for p in previousVersion:
    makePatch(localMainPath+version, localMainPath+p, localMainPatchPath+version)
    makePatch(localLangPath+version, localLangPath+p, localLangPatchPath+version)
