...
def move_to_lang():
    ...
    try:
        moveFiles(TempMainPath + version + "Pro\\Program\\",
                      TempLangPath + version + "Pro\\Program\\")
        moveFiles(TempMainPath + version + "Pro\\Resource\\",
                      TempLangPath + version + "Pro\\Resource\\")
        moveFiles(TempMainPath + version + "Trial\\Program\\",
                      TempLangPath + version + "Trial\\Program\\")
        moveFiles(TempMainPath + version + "Trial\\Resource\\",
                      TempLangPath + version + "Trial\\Resource\\")
    except:
        print ("No Resource/Program Folder in Pro/Trial.")
    ...
    try:
        ...
        myshutil.rmtree(TempMainPath + version + "Pro\\Program\\")
        myshutil.rmtree(TempMainPath + version + "Pro\\Resource\\")
        myshutil.rmtree(TempMainPath + version + "Trial\\Program\\")
        myshutil.rmtree(TempMainPath + version + "Trial\\Resource\\")
