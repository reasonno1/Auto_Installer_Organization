...
version = "1.52SE\\"
previousVersion = "1.51SE\\"

localFolder = "D:\\(Projects)\\CC\\1.52\\Installer\\"
...
localSourceFullPath = localFolder + "SE\\"
localSourceTrialPath = localFolder + "SE\\"
...
def renameFolder():
    try:
        os.rename( localSourceFullPath+"\\Bin64", localSourceFullPath+"\\G6Bin64" )
    except:
        print "Full G6Bin64 already exist."
    try:
        os.rename( localSourceTrialPath+"\\Bin64", localSourceTrialPath+"\\G6Bin64" )
    except:
...
def copyEmptyFolder():
    try:
        myshutil.copytree ( localFolder+templateCommonData+"iClone Character Creator 1 Template\\Motion", localLangPatchPath+"\\1.5\\Data\\Template Common\\iClone Character Creator 1 Template\\Motion" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+templateCommonData+"iClone Character Creator 1 Template\\Texture", localLangPatchPath+"\\1.5\\Data\\Template Common\\iClone Character Creator 1 Template\\Texture" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+customData+"iClone Character Creator 1 Custom\\Motion", localLangPatchPath+"\\1.5\\Data\\Custom Common\\iClone Character Creator 1 Custom\\Motion" )
    except:
        print "already exist."
    try:
        myshutil.copytree ( localFolder+customData+"iClone Character Creator 1 Custom\\Texture", localLangPatchPath+"\\1.5\\Data\\Custom Common\\iClone Character Creator 1 Custom\\Texture" )
    except:
        print "already exist."
